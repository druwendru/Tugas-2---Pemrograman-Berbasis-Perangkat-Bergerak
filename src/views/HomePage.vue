...
<template>
  <ion-page>
    <ion-content :fullscreen="true" class="weather-page">
      ...
      <section class="hero">
        <p class="eyebrow">Tugas 2 • STSI4303 • Pemrograman Berbasis Perangkat Bergerak • Andre Bintang Pramastyo • 050600902      
        </p>
        <h1>Cuaca Jakarta</h1>
        <p class="hero-text">
        ...
        <div class="hero-badges">
          <div class="badge">
            ...
            <strong>{{ weatherData.length }} jam</strong> jumlah total data cuaca yang berhasil diambil dari API.
          </div>
          <div class="badge">
      ...
      <ion-card class="data-card">
        ...
        <ion-card-content>
          ...
          <div v-else>
            ...
            <div class="weather-list"> bagian tabel data cuaca
              <article 
...
// State untuk menyimpan data cuaca, status loading, dan error message agar lebih terstruktur
...
const fetchWeather = async () => {
  try {
    ...
    //proses pengambilan data//lalu diubah menjadi JSON//
    ...
    //setelah itu dimasukkan kedalam weatherData//Bagian ini menggabungkan data waktu dan suhu menjadi satu object.
...
//computed untuk menghitung statistik suhu//Kode berikut mengambil seluruh suhu lalu mencari nilai minimum//
...
//ketika halaman dibuka, function fetchWeather() akan langsung dijalankan otomatis//
onMounted(() => {
  fetchWeather();
});
</script>
